  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900 fade-in">
      <div className="w-full max-w-md card p-8">
        ...
        <button disabled={authInProgress} className="mt-3 w-full border py-2 rounded hover:brightness-95" onClick={async ()=>{ try { await signInWithGoogle() } finally { /* redirect will navigate away */ } }}>{authInProgress ? 'Signing in…' : 'Sign in with Google'}</button>
